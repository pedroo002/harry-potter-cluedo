...
enum class AssetPrefixes {
    DARK_CARDS, HELPER_CARDS, MYSTERY_CARDS, PLAYER_CARDS, DARK_MARK, DARK_CARD_FRAGMENT,
    DICE, DOOR, FOOTPRINT, GATEWAY, NOTE, MAP, SELECTION, TILE, MENU, TUTORIAL,
    MYSTERY_ROOM_TOKENS, MYSTERY_TOOL_TOKENS, MYSTERY_SUSPECT_TOKENS, PLAYER_TOKENS
}
