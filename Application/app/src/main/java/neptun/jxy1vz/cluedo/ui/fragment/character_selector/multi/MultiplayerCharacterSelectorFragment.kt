...
class MultiplayerCharacterSelectorFragment(private val listener: MenuListener) : Fragment(),
    ViewModelListener {
    ...
    override fun onFinish() {
        ...
        mysteryCardIntent.putExtra(
            ...
            fragmentMultiplayerCharacterSelectorBinding.characterSelectorViewModel!!.playerId
        )
