...
val doorList = listOf(
    Door(0, Position(1, 7), roomList[0], R.drawable.door_left),
    Door(1, Position(6, 1), roomList[0]),
    Door(2, Position(5, 8), roomList[1], R.drawable.door_right),
    Door(3, Position(7, 12), roomList[1]),
    Door(4, Position(5, 16), roomList[1], R.drawable.door_left),
    Door(5, Position(1, 17), roomList[2]),
    Door(6, Position(7, 23), roomList[2], R.drawable.door_top),
    Door(7, Position(8, 7), roomList[3], R.drawable.door_left),
    ...
    Door(12, Position(8, 19), roomList[5], R.drawable.door_bottom),
    Door(13, Position(16, 19), roomList[5], R.drawable.door_top),
    Door(14, Position(12, 4), roomList[6]),
    Door(15, Position(16, 7), roomList[6], R.drawable.door_left),
    Door(16, Position(18, 2), roomList[7]),
    Door(17, Position(22, 7), roomList[7], R.drawable.door_left),
    Door(18, Position(17, 12), roomList[8]),
    Door(19, Position(19, 8), roomList[8], R.drawable.door_right),
    Door(20, Position(19, 16), roomList[8], R.drawable.door_left),
    Door(21, Position(17, 22), roomList[9], R.drawable.door_bottom),
...
val slytherinStates = listOf(
    ...
    State(3, 0, 0, DoorState.OPENED, true, 9),
    State(3, 1, 2, DoorState.CLOSED, false, 5),
    State(3, 3, 7, DoorState.CLOSED, false, 9),
    ...
    State(7, 0, 0, DoorState.CLOSED, true),
    State(7, 1, 2, DoorState.CLOSED, false),
    State(7, 3, 7, DoorState.OPENED, false),
...
val ravencalwStates = listOf(
    ...
    State(1, 2, 6, DoorState.OPENED, true, 7),
    State(1, 1, 4, DoorState.CLOSED, false, 0),
    State(1, 5, 12, DoorState.OPENED, false),
    ...
    State(5, 2, 6, DoorState.OPENED, true, 7),
    State(5, 1, 4, DoorState.OPENED, false),
    State(5, 5, 12, DoorState.CLOSED, false),
    ...
    State(12, 2, 6, DoorState.OPENED, true),
    State(12, 1, 4, DoorState.OPENED, false),
    State(12, 5, 12, DoorState.OPENED, false, 0),
...
val gryffindorStates = listOf(
    ...
    State(3, 9, 21, DoorState.CLOSED, true, 2),
    State(3, 8, 20, DoorState.CLOSED, false),
    State(3, 5, 13, DoorState.CLOSED, false, 0),
    ...
    State(12, 9, 21, DoorState.CLOSED, true, 3),
    State(12, 8, 20, DoorState.CLOSED, false, 1),
    State(12, 5, 13, DoorState.OPENED, false),
...
val hufflepuffStates = listOf(
    ...
    State(2, 7, 17, DoorState.CLOSED, true),
    State(2, 8, 19, DoorState.OPENED, false),
    State(2, 6, 15, DoorState.CLOSED, false),
    ...
    State(9, 7, 17, DoorState.OPENED, true,5),
    State(9, 8, 19, DoorState.CLOSED, false, 1),
    State(9, 6, 15, DoorState.OPENED, false),
    ...
    State(13, 7, 17, DoorState.OPENED, true, 9),
    State(13, 8, 19, DoorState.CLOSED, false),
    State(13, 6, 15, DoorState.OPENED, false, 5),
